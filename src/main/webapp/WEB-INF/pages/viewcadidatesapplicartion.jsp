...
<table>
    ...
    <tbody>
            <c:forEach items="${applicationdata}" var="e">
            <tr>
                ...
                <embed class="pdf" 
               src=
"/ProjectSpringMVC_Java1/files/webimages/${e.fresume}"
            width="210" height="250">
            
             <a href="/ProjectSpringMVC_Java1/files/webimages/${e.fresume}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
...
<table>
    ...
    <tbody>
            <c:forEach items="${projectapplicationdata}" var="ef">
            <tr>
        ...
        <embed class="pdf" 
               src=
"/ProjectSpringMVC_Java1/files/webimages/${ef.resumef}"
            width="250" height="250">
            
            
             <a href="/ProjectSpringMVC_Java1/files/webimages/${ef.resumef}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
