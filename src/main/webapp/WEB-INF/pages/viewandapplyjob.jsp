		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" value="${e.tittle}" readonly>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 fl_icon">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" placeholder="Your email" value="${e.skill}" readonly >
				</div>
			</div>
			<div class="col-xs-12">									
				<div class="form-group">
				<label><h2>Job Discription</h2></label>
					<p class="form-input">${e.dicription}</p>
				</div>
			</div>
