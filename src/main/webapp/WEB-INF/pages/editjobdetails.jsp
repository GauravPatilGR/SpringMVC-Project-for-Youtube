...
<html>
  ...
  <body>
    ...
    <div class="testbox">
  <c:forEach items="${jobdetailsofcompany}" var="e">
      ...
      <h1>Post job <i class="fa-solid fa-briefcase"></i> ,What you need done?</h1>
        ...
        <div class="colums">
          ...
          <div class="item">
            ...
            <input type="text" id="fileInput" name="jtittle" value=" ${e.tittle}" placeholder="Software Engineer">
             <br>
          ...
          <div class="item">
            ...
            <input id="address1" height="50px"  value=" ${e.skill}"   name="jskills" required/>
            <h6>Suggested skills:
              MySQL,
              Web Hosting,
              Software Testing,
        ...
        <div class="question">
          <label>What is your estimated budget or Salary?</label>
           <input  type="text"  name="jsalary" value=" ${e.salary}" placeholder="10000,20000"/>
           
          
            <input  type="text"  name="jcname" value="${e.name}"/ readonly>
            
             <input  type="text"  name="jcemail" value="${e.email}"/ readonly>
